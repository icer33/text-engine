const portal_6 = () => ({
    rooms: [
        {
            id: 'portal_6', // unique ID for this room
            name: 'Portal 6', // room name (shown when player enters the room)
            // room description (shown when player first enters the room)
            desc: `Portal 6's room. It is rather empty except for an orb floating in the middle of the room.`,
            onLook: () => {
                const room = getRoom('portal_6');
