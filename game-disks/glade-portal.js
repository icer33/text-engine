const demoDisk = () => ({
  roomId: 'glade', // the ID of the room the player starts in
  rooms: [
    {
      id: 'glade', // unique ID for this room
      name: 'The Glade', // room name (shown when player enters the room)
      // room description (shown when player first enters the room)
      desc: `You find yourself in a serene glade surrounded by tall trees. 
      Rays of sunlight filter through the leaves, creating a dappled effect on the soft green grass beneath your feet. 
      In the center of the clearing, you notice ten glowing portals of different colors hovering above the ground, each pulsing with a gentle energy..
      ...
      onLook: () => {
        const room = getRoom('glade');
        room.desc = `You are currently standing in the forest glade surrounded by ten portals

        Places can have **exits** that take you to other rooms. For instance, **go portal1** will take you through **Portal 1**.

        Places can also contain **items**. Sometimes the player can **TAKE** or **USE** items.

        Type **ITEMS** to see a list of items in the glade. Or type **HELP** to see what else you can do!`;
      },
      ...
      exits: [
        ...
        { dir: ['portal1', 'p1'], id: 'portal_1' },
        { dir: ['portal2', 'p2'], id: 'portal_2' },
        { dir: ['portal3', 'p3'], id: 'portal_3' },
        { dir: ['portal4', 'p4'], id: 'portal_4' },
        { dir: ['portal5', 'p5'], id: 'portal_5' },
        { dir: ['portal6', 'p6'], id: 'portal_6' },
        { dir: ['portal7', 'p7'], id: 'portal_7' },
        { dir: ['portal8', 'p8'], id: 'portal_8' },
        { dir: ['portal9', 'p9'], id: 'portal_9' },
        { dir: ['portal10', 'p10'], id: 'portal_10' },
      ],
    },
    {
      id: 'reception',
