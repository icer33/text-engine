...
function addRoomsToDisk(disk, ...arooms) {
  var newRooms = disk().rooms;
  arooms.forEach(rooms => { newRooms = [].concat(newRooms, rooms().rooms); })
  newroomId = disk().roomId;
  newCharacters = disk().characters
  disk = () => ({
    rooms: newRooms,
    roomId: newroomId,
